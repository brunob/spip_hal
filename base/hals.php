...
function hal_declarer_tables_objets_sql($tables) {
	$tables['spip_hals'] = [
		...
		'statut' => [
			 ['champ' => 'statut','publie' => 'publie','previsu' => 'publie,prop','exception' => ['statut','tout']]
		],
		...
		'champs_versionnes' => ['titre','descriptif','authid','structid','limite'],
	];

	$tables['spip_hals_publications'] = [
		'type' => 'hals_publication',
		'table_objet' => 'hals_publications',
		'table_objet_surnoms' => ['halspublication'],
		'texte_retour' => 'icone_retour',
		...
		'editable' => 'oui',
		'champs_editables' => ['titre','descriptif','soustitre','resume','commentaire','editeur','page','citation_reference','date_production'],
		'rechercher_champs' => [
